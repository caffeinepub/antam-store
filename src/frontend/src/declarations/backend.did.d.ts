...
export interface ShoppingCartItem { 'productId' : string, 'quantity' : bigint }
...
export interface _SERVICE {
  ...
  'getAllOrders' : ActorMethod<[], Array<StoreOrder>>,
  'getCallerUserProfile' : ActorMethod<[], [] | [UserProfile]>,
  'getCallerUserRole' : ActorMethod<[], UserRole>,
  'getCart' : ActorMethod<[], Array<ShoppingCartItem>>,
  'getMyOrders' : ActorMethod<[], Array<StoreOrder>>,
