...
import type { ExternalBlob as _ExternalBlob, OrderStatus as _OrderStatus, Product as _Product, ShoppingCartItem as _ShoppingCartItem, StoreOrder as _StoreOrder, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllOrders(): Promise<Array<StoreOrder>> {
        if (this.processError) {
            try {
    ...
    async getCart(): Promise<Array<ShoppingCartItem>> {
        if (this.processError) {
            try {
    ...
    async getMyOrders(): Promise<Array<StoreOrder>> {
        if (this.processError) {
            try {
...
function from_candid_StoreOrder_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StoreOrder): StoreOrder {
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StoreOrder>): Array<StoreOrder> {
    return value.map((x)=>from_candid_StoreOrder_n14(_uploadFile, _downloadFile, x));
}
